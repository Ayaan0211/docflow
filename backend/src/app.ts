...
const sanitizeDocument = function (
  req: Request,
  res: Response,
  next: NextFunction
) {
...
const sanitizeSharingCredentials = function (
  req: Request,
  res: Response,
  next: NextFunction
) {
...
app.get(
  "/api/documents/:documentId/shared/",
  isAuthenticated,
  function (req: Request, res: Response, next: NextFunction) {
    const docId = parseInt(req.params.documentId);
    const page = parseInt(req.query.page as string);
...
app.patch(
  "/api/documents/:documentId/data/content/",
  isAuthenticated,
  sanitizeContent,
  function (req: Request, res: Response, next: NextFunction) {
    if (!req.body.content)
...
app.patch(
  "/api/documents/:documentId/data/title/",
  isAuthenticated,
  sanitizeTitle,
  function (req: Request, res: Response, next: NextFunction) {
...
app.delete(
  "/api/documents/:documentId/users/",
  isAuthenticated,
  checkEmail,
  function (req: Request, res: Response, next: NextFunction) {
    if (!("email" in req.body)) return res.status(400).end("email is missing");
...
// join document
app.get(
  "/api/documents/:documentId/data/join/",
  isAuthenticated,
  function (req: Request, res: Response, next: NextFunction) {
    const docId = parseInt(req.params.documentId);
    pool.query(
...
// sdp
app.post(
  "/api/documents/:documentId/data/answer/",
  isAuthenticated,
  function (req: Request, res: Response, next: NextFunction) {
    const docId = parseInt(req.params.documentId);
    const desc = req.body;
...
app.get(
  "/api/documents/:documentId/export/docx",
  isAuthenticated,
  async function (req: Request, res: Response, next: NextFunction) {
    const docId = parseInt(req.params.documentId);
